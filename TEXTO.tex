...
mantêm sempre em seu cerne como um mal menor.\footnote{Sobre isso, ver
  por exemplo: \versal{BRAY}, Mark, op.~cit., pp.~54--56; pp.~61--63 e p.~70.} A impressão que se tem é que sempre haverá um liberal
...
isso não apenas porque os fascistas chegam ao poder legalmente,\footnote{Sobre
  isso, ver por exemplo: \versal{BRAY}, Mark, op.~cit., pp.~247--252.} mas porque reside no cerne da representação espetacular do
