...
\chapter[Introdução]{Introdução \subtitulo{Fascismo e antifascismo no século \emph{\versal{XXI}}}}
...
\emph{alt"-right}. No Brasil, grupos anarco"-punks, como o \versal{ACR}
...
nas ruas dos \versal{EUA} em cartazes, como os que levam a sigla \versal{ACAB}
...
\chapter[Um pouco sobre a história do \versal{ACR}]{Um pouco sobre a história do \versal{ACR} -- Anarquistas Contra o Racismo\footnote[*]{Originalmente publicado no site \emph{anarcopunk.org} em 2017.}}
\hedramarkboth{a história do acr}{}
\label{acr}

Criado entre o final de 1992 e o começo de 1993, o Projeto \versal{ACR} foi idealizado e hoje é tocado por anarquistas, e sobretudo por militantes do \versal{MAP} (Movimento Anarco"-Punk), embora esteja aberto à participação de todes.

O movimento anarco"-punk já tinha a luta antifascista e antirracista como uma de suas bandeiras de luta antes da idealização do \versal{ACR}; cada localidade onde o \versal{MAP} existia já vinha desenvolvendo um trabalho dentro da luta antifascista e antirracista, porém, devido às dificuldades existentes na época, ele era desenvolvido de forma superficial, completamente desconectado dos movimentos sociais que também desenvolviam a luta antirracista e sem contato com as ``minorias'' étnicas e de gênero atingidas pelo preconceito, discriminação e pelo racismo.
...
Todas estas constatações a partir de São Paulo encontraram terreno fértil em vários núcleos do \versal{MAP} pelo Brasil, que posteriormente vieram a fazer parte do projeto \versal{ACR}, no caso Santos, Rio de Janeiro e Curitiba.

A ampliação do Projeto \versal{ACR} a outras localidades foi um fato determinante para torná"-lo mais coeso e produtivo, uma vez que o crescimento do nosso projeto sempre foi mais qualitativo do que quantitativo.
...
%\versal{SOMOS O ACR!!! SOMOS O M.A.P.!!! SOMOS OS ANARQUISTAS CONTRA O RACISMO!!}
...
\hedramarkboth{uma luta antifascista}{}
...
Embora as pessoas envolvidas em geral nos \versal{AYM} fossem asiáticas, havia uma identificação enquanto pessoas não"-brancas em uma sociedade branca que lhes dava um sentimento de união com imigrantes africanxs e caribenhxs que passavam pelas mesmas experiências de racismo. Nesse contexto, o termo ``negro'' possibilitou uma identidade coletiva e solidariedade para levar adiante tanto a luta contra o racismo nas ruas, quanto contra suas expressões institucionais e políticas.
...
\begin{bibliohedra}
\tit{ALTAB ALI FOUNDATION}. \emph{Commemorating Altab Ali Day 4 May against racism and fascism}.

\tit{ASIAN YOUTH MOVEMENT BRADFORD}. \emph{Kala Tara} \#1.

\tit{ASIAN YOUTH MOVEMENT MANCHESTER}. \emph{Liberation}.

\tit{ASIAN YOUTH MOVEMENT SHEFFIELD}. \emph{Kala Mazdoor} \#1.

\tit{BOWLING}, Benjamin. \emph{Violent Racism: Victimization, Policing and Social Context}. Inglaterra: Oxford University Press, 1999.

\tit{CAMPAIGN AGAINST RACISM AND FASCISM BOLETIM}. \emph{Racist Activity in Schools}.

\tit{GORDON}, Paul. \emph{Racial Violence and Harassment}. Inglaterra: The Runnymede Trust, 1990.

\tit{KERSHEN}, Anne. \emph{Strangers, Aliens and Asians: Huguenots, Jews and Bangladeshis in Spitalfields 1666--2000}. Inglaterra: Routledge, 2005.

\tit{LONG}, Lisa. \emph{Revolution and Bloodshed: Representations of African Caribbeans in the Leeds press 1968--1989}. Tese de mestrado, Universidade de Huddersfield, Inglaterra.

\tit{MANZOOR}, Sarfraz. ``Black Britain's darkest hour'', \emph{Guardian}, 24/02/2008.

\tit{PROCTER}, James. \emph{Writing Black Britain 1948--1998: An Interdisciplinary Anthology}. Inglaterra: Manchester University Press, 2000.

\tit{RAMAMURTHY}, Anandi. ``Secular Identities and the Asian Youth Movements''. In: \emph{10th International conference on alternative futures and popular protests}. Inglaterra: Manchester Metropolitan University, 2005.
...
\tit{REES}, John \& \versal{GERMAN}, Lindsey. \emph{A People's History of London}. \versal{EUA}: Verso Press, 2012.

\tit{TEARE}, Keith. \emph{Under Siege: Racism and Violence in Britain Today}. Inglaterra: Penguin, 1988.

\tit{THE ASIAN HEALTH AGENCY}. \emph{Young Rebels: The Story of the Southall Youth Movement}.

\tit{THE RACE TODAY COLLECTIVE}. \emph{The Struggle of Asian Workers in Britain Reflecting on the Trial of the Decade: The Bradford 12}.

\tit{WITTE}, Rob. \emph{Racist Violence and the State: A Comparative Analysis of Britain, France and the Netherlands}. \versal{EUA}: Longman, 1996.

\tit{WOOLEY}, Simon. \emph{Ugandan Asians in Britain}, Operation Black Vote.

\tit{The Southall History}. Disponível em: \emph{http://www.thesouthallstory.com}.

\tit{Swadhinata Trust}. Disponível em: \emph{http://www.swadhinata.org.uk/}.

\tit{Tandana -- Glowworm}. Disponível em:  \emph{www.tandana.org}.
\end{bibliohedra}
...
\begin{quote}
A polícia não é o oposto dos fascistas. Eles abusam, sequestram, prendem, deportam e assassinam mais pessoas de cor, mulheres e \versal{LGBTTTIQ} todos os anos do que qualquer grupo fascista. Eles trabalham mais para fazer avançar a agenda supremacista branca do que qualquer organização de extrema direita independente.\footnote{\emph{What they can't do with badges, they do with torches}. Coletivo \emph{CrimethInc.}, 12/08/2019.}
\end{quote}
...
\chapter*{Antifa: contra o que e ao lado de quem lutar \subtitulo{Entrevista com Mark Bray, autor do\break livro \emph{Antifa: o manual antifascista}}\footnote[*]{Originalmente publicado no site \emph{Facção Fictícia} em 05/06/2020.}}
\addcontentsline{toc}{chapter}{Antifa: contra o que e ao lado de quem lutar}
\hedramarkboth{contra o que e ao lado de quem}{}
...
\chapter[Bater onde dói\ldots{} e com força!]{Bater onde dói\ldots{} e com força! \subtitulo{Prefácio à edição brasileira de\break \emph{Antifa: o manual antifascista}}}
\hedramarkboth{Bater onde dói}{}
...
década de 1990, \versal{ACR} (Anarquistas Contra o Racismo).\footnote{Ver capítulo 1, página \pageref{acr}.}
...
\hfill{}\textsc{mark bray\footnote[\dag]{Historiador especialista em direitos humanos, terrorismo e radicalismo político na Europa Moderna. Foi um dos organizadores do movimento \emph{Occupy Wall Street} em 2011 e seu trabalho é referência mundial no debate antifascista.}}
...
\chapter[Somos todos antifascistas?]{Somos todos antifascistas? \subtitulo{Sobre a necessidade de não\break dialogar com o fascismo}}

\hfill{}\textsc{camila jourdan}\footnote[\dag]{É professora associada na \versal{UERJ}; colaboradora no pré-vestibular
  comunitário \versal{ADEP} e é autora do livro \emph{2013: memórias e resistências}. (Ed.
  Circuito, 2018.)}

\hfill{}\textsc{erick rosa}\footnote[\ddag]{É graduado em História pela \versal{UFRRJ}; colaborador no
...
nos domina e nos explora.\footnote{\versal{FOUCAULT}, Michel. ``Introdução à
  ...
  1977, pp.~\versal{XI}--\versal{XIV}. Traduzido por Wanderson Flor do Nascimento.}
...
Por meio das ações diretas, os grupos antifas têm mobilizado
...
se afastam da mobilização de afetos tristes.\footnote{Ver:
  \versal{FOUCAULT}, Michel, op.~cit., pp.~\versal{XI}--\versal{XIV}.} E é por isso que podemos dizer que suas
...
descentralizadas e as redes clandestinas.\footnote{Ver: \versal{BRAY}, Mark, op.~cit., pp.~99--100.}
...
história da colonização\footnote{Aqui é também interessante lembar a
  ...
  \versal{MBEMBE}, Achille. \emph{Necropolítica}. Tradução Renata Santini. São Paulo:
...
com o fim da \versal{II} Guerra Mundial, até porque, como já analisava Maria Lacerda
...
instituição religiosa, a igreja e o clero.\footnote{\versal{MOURA}, Maria Lacerda de.
...
mantêm sempre em seu cerne como um mal menor.\footnote{Ver: \versal{BRAY}, Mark, op.~cit., pp.~54--56; pp.~61--63 e p.~70.} A impressão é de que sempre haverá um liberal
...
isso não apenas porque os fascistas chegam ao poder legalmente,\footnote{Ver: Ibidem, pp.~247--252.} mas porque reside no cerne da representação espetacular do %o que reside no cerne...? 
...
fascistas, ainda que dentro da democracia liberal.\footnote{Essa ideia
  foi desenvolvida pela autora em: \versal{JOURDAN}, Camila. ``Estado Policial e
...
elas.\footnote{Sobre isso, conferir:
  ``Jovem é morto durante entrega de cestas básicas no \versal{RJ}; vizinhos criticam \versal{PM}'', \emph{Uol Cotidiano}, 21/05/2020.
  E: ``Operação policial interrompe doação de cestas e deixa mais um jovem morto no \versal{RJ}'', \emph{Brasil de Fato}, 23/05/2020.}
...
assassinado nesse país, sendo a maioria pela polícia.\footnote{Dados
  disponíveis em:
  ``A cada 23 minutos, um jovem negro é assassinado no Brasil, diz \versal{CPI}'', \emph{Flacso Brasil}, 06/06/2016.} Durante a pandemia, mortes por policias
aumentaram 43\% no Rio de Janeiro.\footnote{Sobre isso, conferir:
  ``Mortes por policiais crescem 43\% no \versal{RJ} durante quarentena, na contramão de crimes'', \emph{Folha de S.\,Paulo}, 26/05/2020.} Um aparato de repressão militar, herança da
...
\chapter[Poesia e antifascismo na América Latina]{Poesia e antifascismo na América Latina \subtitulo{Um espanto de Nogueras, um conselho de\break Roque Dalton e uma sugesta de Torquato}} 
\hedramarkboth{Poesia e antifascismo}{}

\hfill\textsc{rodrigo lobo damasceno}\footnote[\dag]{É Doutor em Letras (Teoria Literária e Literatura Comparada) pela \versal{USP} com pesquisa sobre discursos e práticas antipoéticas e antipolíticas na América Latina. É poeta e um dos editores da revista \emph{Meteöro}.}
...
\begin{bibliohedra}
\tit{BOLAÑO}, Roberto. ``Os perdidos''. Trad. Rodrigo Lobo Damasceno. Disponível
...
\tit{COMITÊ INVISÍVEL}. \emph{Aos nossos amigos -- crise e insurreição}. Trad.
Edições Antipáticas. São Paulo: n-1 edições, 2016.

\tit{GELMAN}, Juan. ``Pensamientos''. Disponível em:
https://www.lexia.com.ar/gelman-pensamientos.htm. Acesso em 24/06/2020.

\tit{LATINAMERICANTIFA}. Trad. e org. Rodrigo Lobo Damasceno. Disponível em:
https://drive.google.com/drive/folders/1lbwHFNPZoPejM1FAS6oB6lTuJGbc1rlx.
Acesso em 24/06/2020.

\tit{MBEMBE}, Achille. \emph{Necropolítica}. Trad. Renata Santini. São Paulo:
n-1 edições, 2018.

\tit{NETO}, Torquato. \emph{Últimos dias de paupéria -- do lado de dentro}. São
Paulo: Max Limonad, 1982.

\tit{ROTHENBERG}, Jerome. \emph{Etnopoesia no milênio}. Trad Luci Collin. Rio
de Janeiro: Azougue Editorial, 2006.

\tit{PARRA}, Nicanor. \emph{Parranda larga}. Buenos Aires: Aguilar, Altea,
Taurus, Alfaguara, 2010.

\tit{RAMA}, Ángel. \emph{A cidade das letras}. Trad. Emir Sader. São Paulo:
Boitempo Editorial, 2015.

\tit{RIBEIRO}, Gustavo Silveira. \emph{Uma alegria estilhaçada}. Escamando \&
Macondo, 2020.
\end{bibliohedra}
...
\hedramarkboth{segurança digital}{}

\hfill{}\textsc{raphael sanz}\footnote[\dag]{Jornalista e editor"-adjunto do \emph{Correio da Cidadania}.}

\bigskip

%\emph{Entrevistamos treinador de segurança digital e ativista da privacidade na internet sobre os vazamentos de dados pessoais de antifascistas. Entenda o contexto, como funcionam, como se prevenir e como agir em caso de ter seus dados vazados.}
...
o anonimato, como a Freenet ou \versal{I2P}. Dessas, a que me sinto mais
...
\chapter{Que fazemos do antifascismo?\footnote[*]{Originalmente publicado na revista \emph{Anarchismo}, nº 74, 09/1994. Tradução de André Tunes.}}
...
\hedramarkboth{querem nos fazer desejar seu governo}{}
...
como faixas pró"-intervenção militar e a favor do \versal{AI}-5; homenagens a
...
\chapter[Posfácio]{Posfácio \subtitulo{Lutas contra a extrema direita,\break ação direta e criminalizações}}
