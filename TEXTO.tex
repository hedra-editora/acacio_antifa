...
ao lado do então candidato a governador Wilson Witzel (\versal{PSC}), com o nome
da vereadora Marielle Franco, executada em 2018, apresentou a \versal{PL}
...
\chapter{Um pouco sobre a história do \versal{ACR} -- Anarquistas Contra o Racismo\footnote[*]{Originalmente publicado no blog \emph{anarcopunkorg}.}}
\hedramarkboth{um pouco sobre a história do acr}{}

Criado no final de 1992, começo de 1993, o Projeto \versal{A.C.R.} foi idealizado e hoje é tocado por anarquistas e em maior número por militantes do \versal{MAP} (Movimento Anarco"-Punk), embora esteja aberto a participação de tod@s.

O movimento anarco"-punk já tinha a luta antifascista e antirracista como uma das bandeiras de luta antes da idealização do \versal{A.C.R.}, cada localidade onde havia o \versal{MAP}, já vinha desenvolvendo um trabalho dentro da luta antifascista e antirracista, porém as dificuldades existentes na época eram este trabalho era desenvolvido de forma superficial, completamente desconectado dos movimentos sociais que também desenvolviam a luta antirracista e sem contato com as ``minorias'' étnicas e de gênero atingidas pelo preconceito, discriminação e pelo racismo.

Mesmo entre os núcleos do \versal{MAP} o trabalho antirracista carecia de estruturação orgânica, coesão e de intercâmbio internúcleos. A partir desta análise, alguns indivíduos de São Paulo que não participavam necessariamente dos mesmos coletivos iniciaram uma articulação local que transformou"-se no que hoje é o Projeto \versal{A.C.R.}
...
Passada a indignação inicial, os meios de comunicação deixaram de divulgar o caso, nenhum neonazista foi preso, a dimensão inicial do fórum antirracista foi esvaziado e quase tudo voltava ao normal.

Nós dissemos quase tudo\ldots{}

\ldots{} Dias após a passeata do dia 13 de maio, um militante nosso foi atacado e violentamente espancado por neonazistas do grupo ``carecas do \versal{ABC}'', tomou vários pontos na testa, alguns dentes a menos e um pequeno afundamento facial.
...
Todas estas constatações a partir de São Paulo encontraram terreno fértil em vários núcleos do \versal{MAP} pelo Brasil, núcleos estes que posteriormente vieram a fazer parte do projeto \versal{A.C.R.}, no caso Santos, Rio de Janeiro e Curitiba.
...
Os núcleos existentes atualmente Criciúma, Curitiba, Rio de Janeiro, Santos, São Paulo (e um núcleo colaborador em Cruzeiro -- \versal{SP}) buscam desenvolver trabalhos com as comunidades e movimentos sociais de suas regiões dentro de uma linha geral de conduta aprovada de forma horizontal por todos os núcleos.
...
\chapter[O Movimento Anarcopunk e a luta antifascista no Brasil]{O Movimento Anarcopunk e\break a luta antifascista no Brasil\footnote[*]{Originalmente publicado no blog \emph{Imprensa Marginal}.}}
\hedramarkboth{O Movimento Anarcopunk}{}
...
\chapter[``Aqui para ficar, aqui para lutar'']{``Aqui para ficar, aqui para lutar'' \subtitulo{O florescer de uma luta antifascista}}
...
Kala Tara \#1, publicação \versal{AYM} Bradford, 1979.
\end{quote}
...
\epigraph{A Grã"-Bretanha tomou conhecimento do termo paki"-bashing pela primeira vez na última quarta"-feira. Um grupo de skinheads se gabava pela \versal{TV} de ter espancado imigrantes na Zona Leste de Londres, por pura diversão}{\textit{Jornal Sunday Mirror}, 1969}
...
Com o crescimento de organizações como a National Front neste período, para além de uma intensa atividade de propaganda racista, passam a ocorrer muitos casos de violência protagonizados diretamente por membros de partidos políticos de extrema direita. Um relatório apresentado em meados dos anos 70 por um membro do parlamento, Paul Rose, denunciava mais de 1000 incidentes de violência com envolvimento de grupos de extrema"-direita como a National Front. Outras evidências relacionam a \versal{NF} a diversos ataques a bomba, panfletagens racistas e ataques ao Community Relations Office em Londres. A \versal{NF} organizou comícios de rua com propaganda abertamente racista, distribuíram panfletos racistas em regiões caracterizadas pela grande quantidade de moradorxs imigrantes, como Brick Lane, entre outras ações públicas. Há também relatos que apontam o racismo institucional em escolas, locais de trabalho e diversas outras situações e ambientes do cotidiano das comunidades imigrantes.
...
Jovens asiáticxs começaram a organizar e criar redes e alianças entre diferentes escolas e vizinhanças para defender e proteger a si mesmxs contra ataques racistas e apoiarem"-se nos problemas sociais e culturais comuns que afetavam as comunidades. Estas redes e alianças eram a infraestrutura embrionária que levaria xs jovens a consolidar e formalizar o Southall Youth Movement (\versal{SYM}).\footnote{Balraj Purewal, membro fundador da Southall Youth Movement in \versal{THE ASIAN HEALTH AGENCY} -- Young Rebels: The Story of the Southall Youth Movement.}
\end{quote}
...
\epigraph{(\ldots{}) para muitas da segunda geração de pessoas asiáticas que cresceram na Inglaterra durante os anos 70 e 80, a religião não foi um aspecto primário de definição de suas identidades. O assunto chave foi o racismo, que confrontavam na escola, nas ruas, nos lugares onde suas famílias poderiam morar e trabalho, produzindo uma ampla identidade antirracista em torno do qual se organizaram}{\textit{Secular Identities and the Asian Youth Movements}, Dr Anandi Ramamurthy, University of Central Lancashire}

Entre 1973 e 1977, vão surgindo algumas tentativas de formar redes de comitês antifascistas/antirracistas que envolviam pessoas e grupos dos mais diversos contextos. Em junho de 74, antifascistas organizaram uma passeata até o centro de Londres, contrapondo um comício da National Front. A manifestação acabou em conflitos com a polícia e membros da \versal{NF}, e o manifestante Kevin Gately foi assassinado. Em fevereiro de 75 é criada a revista antifascista Searchlight, com o objetivo de contestar o apoio eleitoral à \versal{NF}, seguida pelo surgimento do jornal Campaign Against Racism and Fascism (\versal{CARF}), publicado pela primeira vez no final de 76 pelo Richmond \& Twickenham Anti"-Racist Committee e a partir de 77 adotado como jornal da All London Anti"-Racist, Anti"-Fascist Co"-ordinating Committee, uma federação formada por 23 comitês antifascistas locais. Em 77 também surge a Anti"-Nazi League, que com o passar dos anos tem um grande crescimento, com bases em diversos setores sociais, entre outras organizações. Nesse momento também cresce a oposição à \versal{NF} por parte do Labour Party, que avaliando o crescimento do sucesso eleitoral da Front concorda com uma campanha contra o racismo e reivindica a revogação das leis de imigração de 1968 e 1971.
...
A partir desta experiência do \versal{SYM}, diversas iniciativas semelhantes começam a surgir em outras comunidades. Ainda em 76 surge a Asian Youth Organisation (\versal{AYO}) em Bolton e Blackburn, e o embrião da Bangladesh Youth Movement (\versal{BYM}); em 77 nasce a Asian Youth Movement (\versal{AYM}) em Bradford, em um primeiro momento com o nome de Indian Progressive Youth Association (\versal{IPYA}); em 78 a Asian Action Group de Haringey; em 79 a Asian Youth Movement de Leicester e Manchester; e o começo dos anos 80 vai ampliando o movimento em outras localidades: surge a Asian Youth de Birmingham e a United Black Youth League de Bradford em 81, e em 82 a \versal{AYM} Sheffield. Aos poucos os \versal{AYM}s e outros movimentos semelhantes iriam se espalhando por East London, Luton, Nottingham, Leicester, Manchester, Sheffield, Burnley, Birmingham, Pendle, Watford e outros lugares.
...
Nas Eleições Gerais de 1979, a National Front emplacou 303 candidatos, o que não só colocava o partido em outro patamar na política nacional, como lhe dava o direito a tempo no rádio e televisão. Em resposta, a \versal{ANL} e seus apoiadores se apuseram à \versal{NF} em todos os lugares em que fizessem comícios eleitorais.

Em abril, a National Front realizaria um comício eleitoral no Southall Town Hall, o que foi considerado como uma provocação, já que Southall tinha uma das maiores comunidades asiáticas do país. Um dia antes do comício, cinco mil pessoas marcharam até Ealing Town Hall para protestar contra a \versal{NF}, entregando uma petição assinada por 10.000 moradorxs. No dia seguinte, 23 de abril, lojas locais, fábricas e transporte público pararam em greve a partir das 13hs, e a rua foi bloqueada. Mais de dois mil policiais foram proteger os apoiadores da \versal{NF}, em muitos casos escoltando"-os até o local. Pouco depois, conforme Balwindar Rana relembra, `(\ldots{}) um ônibus passou, com skinheads dentro, fazendo sinal de \versal{V}. Alguns dxs jovens asiáticxs começaram a brigar com os skinheads, e a polícia respondeu agredindo xs asiáticxs.'. Com participação de centenas de manifestantes, este ato se tornou uma batalha com a polícia, que teve 40 pessoas feridas e 300 presas. Pelo menos três pessoas tiveram traumatismo craniano, e outras foram espancadas até perderem a consciência. Militantes antirracistas passaram a noite toda resgatando garotxs asiáticxs que foram presxs pela policia e que, após apanharem, eram jogadxs nos arredores distantes de Londres. 
...
\begin{quote}
Os restos queimados da Hambrough Tavern se tornaram um santuário da resistência da comunidade aos ataques racistas e uma cena de alegria para a comunidade local. O Incêndio na Hambrough Tavern enviou um sinal pelo país de que Southall era uma área imprópria para racistas e de que a comunidade asiática iria se erguer e defender a si mesma.\footnote{Balraj Purewal, da Southall Youth Movement in \versal{THE ASIAN HEALTH AGENCY} -- Young Rebels: The Story of the Southall Youth Movement.}
\end{quote}
...
Desde 1977, a Young National Front, braço da \versal{NF}, passa a atuar focada na juventude, como uma das primeiras organizações a lançar campanhas em escolas. A \versal{YNF} também difundia o boletim Bulldog, editado por Joe Pearce, e suas investidas com grupos de jovens e bandas musicais de caráter nacionalista rendeu a aproximação com Ian Stuart e a banda Skrewdriver, que seriam peças chave na consolidação de skinheads White Power, abertamente neonazistas, na Inglaterra.

A violência racista nas escolas e playgrounds também ganhava maior impulso, e surgiriam inclusive organizações de professorxs brancxs com o intuito de dar aulas particulares para as crianças brancas. Neste momento já existem movimentos como a All London Teachers Against Racism and Fascism (\versal{ALTARF}), com monitoramento dos incidentes racistas e atividades de combate.
...
\begin{quote}
As organizações negras da cidade, particularmente a comunidade Bangladesh e a \versal{AYM}, mostraram como a resistência unida pode ser efetiva. (\ldots{}) Agora é hora de nos livrarmos de todas as hesitações que temos. Precisamos nos unir. Precisamos defender os direitos de nossa própria comunidade (\ldots{}) Nosso direito a permanecer aqui e nosso direito de lutar contra o racismo.
...
\begin{Parskip}
\versal{ALTAB ALI FOUNDATION} -- Commemorating Altab Ali Day 4 May against racism and fascism

\versal{ASIAN YOUTH MOVEMENT BRADFORD} -- Kala Tara \#1

\versal{ASIAN YOUTH MOVEMENT MANCHESTER} -- Liberation

\versal{ASIAN YOUTH MOVEMENT SHEFFIELD} -- Kala Mazdoor \#1

\versal{BOWLING}, Benjamin -- Violent Racism: Victimization, Policing and Social Context

\versal{CAMPAIGN AGAINST RACISM AND FASCISM BOLETIM} -- Racist Activity in Schools

\versal{GORDON}, Paul -- Racial Violence and Harassment

\versal{KERSHEN}, Anne -- Strangers, Aliens and Asians: Huguenots, Jews and Bangladeshis in Spitalfields 1666--2000

\versal{LONG}, Lisa -- Revolution and Bloodshed: Representations of African Caribbeans in the Leeds

\versal{MANZOOR}, Sarfraz -- Black Britain's darkest hour

\versal{PROCTER}, James -- Writing Black Britain 1948--1998: An Interdisciplinary Anthology
\versal{RAMAMURTHY}, Anandi -- Secular Identities and the Asian Youth Movements

\versal{RAMAMURTHY}, Anandi -- Kala Tara: A History of the Asian Youth Movements in Britain in the 1970s and 1980s

\versal{REES}, John \& \versal{GERMAN}, Lindsey -- A People's History of London

\versal{TEARE}, Keith -- Under Siege: Racism and Violence in Britain Today

\versal{THE ASIAN HEALTH AGENCY} -- Young Rebels: The Story of the Southall Youth Movement

\versal{THE RACE TODAY COLLECTIVE} -- The Struggle of Asian Workers in Britain Reflecting on the Trial of the Decade: The Bradford 12

\versal{WITTE}, Rob -- Racist Violence and the State: A Comparative Analysis of Britain, France and the Netherlands

\versal{WOOLEY}, Simon -- Ugandan Asians in Britain. Operation Black Vote
...
\chapter[Não começou ontem, não vai terminar com as eleições]{Não começou ontem, não vai\break terminar com as eleições\footnote[*]{Originalmente publicado no blog \emph{Imprensa Marginal}.}}
...
\chapter*{Somos todos antifa, menos a polícia\subtitulo{Sobre como e com quem lutamos}\footnote[*]{Originalmente publicado no blog \emph{Facção Fictícia}.}}
...
\section{A violência não acaba, mas é direcionada\break contra as minorias}
...
\chapter*{Antifa: contra o que e ao lado de quem lutar \subtitulo{Entrevista com Mark Bray, autor do livro \emph{Manual Antifa}}\footnote[*]{Originalmente publicado no blog \emph{Facção Fictícia}.}}
...
\textbf{Como você define o que chama, em seu livro, de antifa moderna e como ela contribui para o cenário de protestos atuais contra o racismo e a polícia nos \versal{EUA}?}
...
\textbf{As táticas antifa se mostraram a forma mais radical de resistência ao governo Trump nos \versal{EUA} ao governo Bolsonaro no Brasil, trazendo uma herança de práticas radicais e anticapitalistas. Como você vê adesão da esquerda institucional, dentro dos palácios e gabinetes, aos símbolos e discursos antifa?}
...
\chapter{Bater onde dói\ldots{} e com força!}
...
apenas de um libelo
panfletário. Seu autor, Mark Bray (1982), é historiador de profícua
produção universitária e professor de História Moderna no Dartmouth 
College, uma instituição com mais de 250 anos, \linebreak

\noindent{}localizada na cidade de
...
integrante da \versal{IWW} (Industrial Workers of the World) e foi ativo
participante nos grupos Press Working Group (\versal{WG}) e Direct Action (\versal{DA})
que ajudaram na organização, em 2011, do Occupy Wall Street (\versal{OWS}), em
Nova Iorque. Movimento sobre o qual Mark Bray produziu um belo livro que
...
\emph{Occupy''}\footnote{Nos referimos aqui ao texto de Chris Hedges,
  ``The Cancer in Occupy'', publicado em 6 de fevereiro de 2012,
  disponível em
  \emph{https://www.truthdig.com/articles/the-cancer-in-occupy/}.
  Texto que recebeu um resposta certeira de David Graeber no texto
  ``Concerning the Violent Peace-Police'', publicado logo em seguida na
  revista n+1, disponível em
  \emph{https://nplusonemag.com/online-only/online-only/concerning-the-violent-peace-police/}.
  Links consultados em 1 de janeiro de 2020.} (qualquer semelhança com
...
Nesta reimpressão, após ter nos visitado em julho de 2019 para os
lançamentos da edição brasileira de seu \emph{Manual Antifa}, podemos
...
resquícios das teoria lombrosiana da degenerescência seguem presente nas
...
Lançado originalmente em inglês, em 2017, \emph{Antifa -- O Manual
Antifascista} é, nas palavras do próprio autor, um livro que almeja
...
dominante e majoritário, como foi no período do entre guerras europeu na
...
em suas formas variadas e dissimuladas. Talvez perspectiva faz deste
...
\emph{antifa}. Evita"-se a confortável posição da crítica que mira
...
leitores brasileiros no site da Revista Serrote. No entanto, sua edição
...
neo"-integralistas no Brasil, inclusive com ações violentas espetaculares
...
Novamente é preciso voltar a análise para o efeitos da crise de 2008.
...
ecológica e da democracia planetária. Movimentos como 15M na Espanha e
...
\emph{antipolítica}, como colocado militantes gregos de
...
O alvo dos movimentos que autor nomeia como ``antifa moderna
(1945--2003)'' é o fascismo contemporâneo. Ele apresenta a \emph{antifa
moderna} no capítulo dois como oriundos dos movimentos autonomistas e
anarco"-punks na Europa. Esse grupo reagem de várias maneiras à conduta
regular e cotidiana de cidadãos em suas manifestações racistas,
(neo)nacionalistas ou etno"-nacionalistas, misóginas e islamofóbicas.
...
extermino de pobres e negros no Brasil pode ser antifascista? Essa é uma
questão. E isso ganha dimensão enorme no Brasil, o último país a abolir
a escravidão nas Américas (1888)\footnote{Ver Marcel Dorigny. As
...
universidades, ele se encerra com um alerta que fazemos questão de
...
sacrossanta liberdade e expressão.
...
qualquer política de Estado. A após um ano de gorveno eleito abundam os
...
década de 1990, A.C.R. (Anarquistas Contra o Racismo), cuja história é
possível ler aqui:
\emph{https://anarcopunk.org/v1/2017/05/um-pouco-sobre-a-historia-do-acr-anarquistas-contra-o-racismo/}
...
também não glorifica"-la, nem torná"-la, como tática, um fim em si mesma.
...
pelos antifas e as fantifas para iguala"-los aos fascistas. Em países
...
coisas devem ficar explícitas para luta antifascista: 1) que ela é uma
...
dezembro de 2008, em meio as chamas anarquistas em Atenas, no documento
...
impele a insurreição que deverá destruí"-lo. Um exagero? Talvez. Mas se
...
respondeu mais ou menos assim: não tememos a ruína, tudo que você vê a
...
bolsonarismo mostrou que é urgente a radicalização das lutas e que pouco
coisas vai mudar se tudo continuar orbitando os processos eleitorais.
...
\vfill{}\hfill{}São Paulo, 09 de janeiro de 2020.

\chapter*{Antifa não é o problema \subtitulo{A falação de Trump é uma
distração\break para a violência policial}}
...
Recentemente a onda de dos protestos nos \versal{EUA}, que se espalhou por vários
...
sentido dos movimentos antifascistas, que os apague enquanto alternativa
diferenciada de luta. Quando se diz `\emph{somos todos antifas'}, isso é
...
anos 80 e também, alguns deles, nas torcidas organizadas de futebol,
...
que se organizam para impedir o fascismo de crescer, seja por impedir
uma manifestação fascista, seja por impedir o fascismo no micro da
sociedade. Os movimentos \emph{antifas} são movimentos que defendem a
auto"-defesa; a ação direta e a resistência não"-institucional contra o
...
E é interessante notar que o nascimento contemporâneo da \emph{antifa}
...
Floyd deu início à insurreição atual.\footnote{``Podemos localizar a
  ...
  um grupo de skinheads antirracistas e multirraciais chamados Baldies
  esta reunido durante as férias de natal em dezembro de 1987.'' \versal{BRAY},
  M. \emph{Antifa: o Manual antifascista}. Tradução Guilherme Ziggy. São
...
rompendo com dualismos e com a separação entre meios fins buscados.
...
e contrainformação. Adicionalmente, toda a luta na micro"-política onde o
...
nos domina e nos explora.''\footnote{\versal{FOUCAULT}, M. \emph{Introdução à
  vida não"-fascista} Preface in: Gilles Deleuze e Félix Guattari.
  Anti"-Oedipus: Capitalism and Schizophrenia, New York, Viking Press,
...
nosso comportamento?''\footnote{\emph{Idem}, p.03.}
\end{quote}

Os grupos \emph{antifas} na contemporaneidade defendem que é um equívoco
...
quando as classes dominantes amedrontadas de uma sociedade em completa
...
ambiente do \emph{homenzinho} reacionário''.\footnote{
  \versal{REICH}, W. \emph{Psicologia de Massas do Fascismo} (1946). Tradução
...
fato de ser sustentado e defendido por massas humanas.\footnote{\emph{Idem},
  p. 12.}
\end{quote}

O problema dos fascismos cotidianos, dos micro"-fascismos com os quais
...
podia tê"-lo feito a muito tempo. Ao invés disso, contemporizou,
...
de Moura na década de 20, é o filho predileto do Estado e do Capital. Em
...
mantém sempre em seu cerne, como um mal menor.\footnote{Sobre isso, ver
  ...
  Guilherme Ziggy. São Paulo: Autonomia Literário, 2019, pp. 54--56 ; pp.
  61--63 e p.70.} A impressão que se tem é que sempre haverá um liberal
...
isso não apenas porque os fascistas chegam ao poder legalmente,\footnote{Sobre
  ...
  Tradução Guilherme Ziggy. São Paulo: Autonomia Literário, 2019, pp.
  247--252.} mas porque reside no cerne da representação espetacular do
...
\chapter[Um espanto de Nogueras, um conselho de Roque Dalton e uma sugesta de Torquato]{Um espanto de Nogueras, um conselho de Roque Dalton e uma sugesta de Torquato \subtitulo{Poesia e antifascismo na América Latina}}
...
progressistas dos anos 60 e 70 --- movimentação essa pensada, formulada e
...
skinheads, música extrema, torcidas de futebol, pornografia,
...
obscurantismo de extrema de direita, ora beirando o nazi"-fascismo, ora
engrossando o coro de saudosismo pela ditadura empresarial"-militar de 64
...
democrático"-burguesas e micro poderes, ou seja, onde sempre esteve. E
...
\textbf{Como avalia a repercussão do recente vazamento de informações
...
\textbf{O que comenta sobre a recente atuação de páginas dos Anonymous
...
\textbf{Que tipos de hábitos das pessoas nas redes são nocivos no
...
\textbf{Quais os perigos à privacidade que as redes apresentam em casos
como esse?}
...
\textbf{Que medidas uma pessoa que precisa se expor com mais frequência
...
\textbf{Aparentemente, não houve invasões de perfil, pois todos os dados
...
\textbf{Como explicaria para um leigo a deep web, como funcionam os
...
Ao invés de se conectar diretamente aos sites que deseja acessar, na
...
\textbf{Vazaram meus dados! E agora? O que devo fazer? Como proteger
