...
\qquad \qquad \qquad \qquad \quad \, Jean Tible (\versal{DCP/USP}),\\
...
\end{flushleft}
\versal{A}923 \hspace{5pt}Augusto, Acácio (organização)\\
\hspace{20pt}\parbox{185pt}{Antifa: modo de usar / Acácio Augusto. -- Rio de Janeiro: Circuito, 2020. (Coleção Ataque)}\\[2pt]

\hspace{20pt}190 p.\\[6pt]

\hspace{20pt}\versal{ISBN} 978-85-7715-652-8\\[6pt]
...
%logos
\vfill
\ifdef{\logo}{\IfFileExists{\logo}{\hfill\includegraphics[width=3cm]{\logo}\hfill\logoum{}\\ São Paulo\_\the\year}}{\includegraphics[width=2cm]{./logo_hedra.png}\hspace{.5cm}\includegraphics[width=2cm]{CIRCUITO.jpg}\break{} Rio de Janeiro\quad\the\year}
